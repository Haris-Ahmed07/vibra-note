...
function FeaturedSection() {
    ...
    return (
        <div className="py-10 bg-gray-900 flex flex-col justify-center items-center px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center sm:mx-10 lg:mx-20">
                    {featuredCourses.map((course: Course) => (
                        <div key={course.id} className="h-full">
                            <BackgroundGradient className="h-full rounded-[22px] p-6 bg-white dark:bg-zinc-900 overflow-hidden flex flex-col">
                                <div className="flex flex-col items-center text-center h-full">
                                    <h3 className="text-xl font-semibold mb-3 line-clamp-2 h-16 flex items-center justify-center">{course.title}</h3>
